...
CONTEST_IDS=("708:1497" "712:1504" "714:1513" "716:1514" "717:1516" "718:1517")

# Function to process a single round
process_round() {
    local round=$(echo $1 | cut -d: -f1)
    local contest_id=$(echo $1 | cut -d: -f2)
...
for round_info in "${CONTEST_IDS[@]}"; do
